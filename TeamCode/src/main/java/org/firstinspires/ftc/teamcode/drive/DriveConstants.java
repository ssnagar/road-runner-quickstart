...
public class DriveConstants {
     ...
     */
    // This code is specifically for Dead Wheels with no drive encoder configuration
    ...
    public static double TRACK_WIDTH = 16.34; // in ---- This needs to be checked and updated ----
